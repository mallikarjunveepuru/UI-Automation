...
@Listeners(org.uncommons.reportng.HTMLReporter.class)
	...
	@Test
	public void Addsourcecontrol(@Optional String param,@Optional String param1,@Optional String param2,@Optional String cloud,@Optional String clust) throws  IOException, AWTException, InterruptedException{
		if(param2.equals("gitlab")){
			utility.Addsourcecontrolgitlab(param, param1);
		}
		else{
	...
	@Test
	public void Addsourcecontrolvalidation(@Optional String param,@Optional String param1,@Optional String Depends,@Optional String suiteName,@Optional String cloud,@Optional String clust) throws  IOException, AWTException, InterruptedException{
		...
		if(param1.equals("gitlab")){
			utility.Addsourcecontrolgitlabvalidation(param);
		}else{
	...
	@Test
	public void sourceControlDeletion(@Optional String param,@Optional String cloud,@Optional String clust) throws InterruptedException, IOException {
		  utility.sourceControlDeletion(param);
	}
	@Parameters({"param", "Depends","suiteName","cloud","clust"})
	@Test
	public void sourceControlDeletionValidation(@Optional String param,@Optional String Depends,@Optional String suiteName,@Optional String cloud,@Optional String clust) throws InterruptedException, IOException {
		FileInputStream skip = new FileInputStream(workspace + "/src/file.Properties");
		  prop.load(skip);
		  if (prop.getProperty(cloud+suiteName+Depends).equals("FAIL") ) {throw new SkipException("Skip");}
	...
	@Parameters({"param","cloud","clust"})
	@Test
	public void createCluster(@Optional String param,@Optional String cloud,@Optional String clust) throws InterruptedException, IOException {
		if(cloud.equals("Google") && clust.equals("kub")){
			System.out.println("Google");
		utility.createCluster(param);
		}
		else if(cloud.equals("Azure") && clust.equals("swarm")){
			System.out.println("Azuresw");
			utility.swarmCreation(param);
		}
		else if(cloud.equals("Azure") && clust.equals("kub")){
			System.out.println("Azureku");
			utility.createAzureCluster(param);
		}
		else if(cloud.equals("Direct") && clust.equals("kub"))
		{
			System.out.println("Google");
			utility.createdirectCluster(param);
		}
	}
	@Parameters({"param", "Depends","suiteName","cloud","clust"})
	@Test
	public void clusterValidation(@Optional String param, @Optional String Depends,@Optional String suiteName,@Optional String cloud,@Optional String clust) throws InterruptedException, IOException {
		FileInputStream skip = new FileInputStream(workspace + "/src/file.Properties");
		  prop.load(skip);
		  if (prop.getProperty(cloud+suiteName+Depends).equals("FAIL")) {throw new SkipException("Skip");}
		  if(cloud.equals("Google") || cloud.equals("Azure")){
		  utility.clusterValidation(param);
		  }
		  else{
			  utility.clusterRegistration(param);
		  }
	}
	@Parameters({"param","cloud","clust"})
	@Test
	public void clusterDeletion(@Optional String param,@Optional String cloud,@Optional String clust) throws InterruptedException, IOException {
		...
		utility.clusterDeletion(param);
		  ...
		  {
			  utility.directClusterDeletion(param);
			  utility.clusterDeletion(param);
		  }
	}
	@Parameters({"param","cloud","clust", "Depends","suiteName"})
	@Test
	public void clusterDeletionvalidation(@Optional String param,@Optional String cloud,@Optional String clust, @Optional String Depends,@Optional String suiteName) throws InterruptedException, IOException {
		FileInputStream skip = new FileInputStream(workspace + "/src/file.Properties");
		  prop.load(skip);
		  if (prop.getProperty(cloud+suiteName+Depends).equals("FAIL") || prop.getProperty(cloud+suiteName+Depends).equals("SKIP") ) {throw new SkipException("Skip");}
		 if(cloud.equals("Google") || cloud.equals("Direct")){
	...
	@Test
	public void stopAction(@Optional String param,@Optional String param1,@Optional String cloud,@Optional String clust) throws InterruptedException, IOException {
	...
	public void cdeliveryOn(@Optional String param,@Optional String param1,@Optional String param2,@Optional String param3,@Optional String Depends,@Optional String suiteName,@Optional String cloud,@Optional String clust) throws InterruptedException, IOException, AWTException {
		/*FileInputStream skip = new FileInputStream(workspace + "/src/file.Properties");
		  prop.load(skip);
		  if (prop.getProperty(cloud+suiteName+Depends).equals("FAIL") || prop.getProperty(cloud+suiteName+Depends).equals("SKIP") ) {throw new SkipException("Skip");}
		 */ utility.cdeliveryOnsingletier(param,param1,param2,param3);
	}
	@Parameters({"param","param1","param2","param3","Depends","suiteName","cloud","clust"})
	@Test
	...
	@Test
	public void deleteApp(@Optional String param,@Optional String suiteName,@Optional String Depends,@Optional String cloud,@Optional String clust) throws InterruptedException, IOException {
		FileInputStream skip = new FileInputStream(workspace + "/src/file.Properties");
		  prop.load(skip);
		  if (prop.getProperty(cloud+suiteName+Depends).equals("FAIL") || prop.getProperty(cloud+suiteName+Depends).equals("SKIP") ) {throw new SkipException("Skip");}
