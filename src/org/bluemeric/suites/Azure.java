...
public class Azure {
	...
	public void login(String cloud) throws IOException, InterruptedException {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id(prop.getProperty("azureuserid")))).sendKeys(prop.getProperty("Azureusername"));
		 wait.until(ExpectedConditions.visibilityOfElementLocated(By.id(prop.getProperty("azuresignin")))).click();
		 Thread.sleep(10000);
		 wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(prop.getProperty("azurepassword")))).sendKeys(prop.getProperty("Azurepassword"));
		 Thread.sleep(10000);
